                            ...
                            <div class="widget-content nopadding">
                                <form action="#" method="get" class="form-horizontal" id="addUser">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span3" name="username" id="username" placeholder="test001" value="test001" disabled>
                                        </div>                                        
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-danger" name="submit" id="submit">修改</button>
